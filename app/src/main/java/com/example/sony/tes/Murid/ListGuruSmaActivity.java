 ...
 */
public class ListGuruSmaActivity extends AppCompatActivity {
    ...
    private GuruSmaAdapter adapter;
...
//        getSupportActionBar().hide();
        ...
        histori.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ListGuruSmaActivity.this, HistoryMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ListGuruSmaActivity.this, SettingMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        transaksi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ListGuruSmaActivity.this, TransaksiMuridActivity.class);
                startActivity(i);
            }
        });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new GuruSmaAdapter(result, getApplicationContext());
                            adapter.setListener(new ItemClickListenerBebas() {
                                @Override
                                public void onClicked(Guru guru, int position, View view) {
                                    Intent i = new Intent(ListGuruSmaActivity.this, DetailOrderActivity.class);
