...
import com.example.sony.tes.Adapter.PelajaranSmaAdapter;
...
import com.example.sony.tes.Murid.ListGuruSmaActivity;
 ...
 */
public class PelajaranSmaActivity extends AppCompatActivity {
    ...
    private PelajaranSmaAdapter adapter;




    //    private  static  final String url = "http://t-hisyam.net/demo/whyri/vote/list_vote.php";
    private static final String url = "http://demo.t-hisyam.net/ihave/api/lesson/get_data?id_category=4";
...
//        getSupportActionBar().hide();
        setContentView(R.layout.activity_pelajaran_sma);

        lstPelajaran = (RecyclerView) findViewById(R.id.lst_pel_sma);
        ...
        histori.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PelajaranSmaActivity.this, HistoryMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranSmaActivity.this, SettingMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        transaksi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranSmaActivity.this, TransaksiMuridActivity.class);
                startActivity(i);
            }
        });
    ...
    private void fetchPelajaran() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, onPostsLoaded, new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder inetErr = new AlertDialog.Builder(PelajaranSmaActivity.this);
...
//            pel data = new Gson().fromJson(getIntent().getStringExtra("data"), pel.class);
            ...
            adapter = new PelajaranSmaAdapter(test);

            adapter.setListener(new ItemClickListenerPelajaran() {
                @Override
                public void onClicked(pel pel, int position, View view) {
                    Intent i = new Intent(PelajaranSmaActivity.this, ListGuruSmaActivity.class);
