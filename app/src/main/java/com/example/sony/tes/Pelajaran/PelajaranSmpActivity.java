...
import com.example.sony.tes.Adapter.PelajaranSmpAdapter;
...
import com.example.sony.tes.Murid.ListGuruSmpActivity;
 ...
 */
public class PelajaranSmpActivity extends AppCompatActivity {
    ...
    private PelajaranSmpAdapter adapter;




    //    private  static  final String url = "http://t-hisyam.net/demo/whyri/vote/list_vote.php";
    private static final String url = "http://demo.t-hisyam.net/ihave/api/lesson/get_data?id_category=3";
...
//        getSupportActionBar().hide();
        setContentView(R.layout.activity_pelajaran_smp);

        lstPelajaran = (RecyclerView) findViewById(R.id.lst_pel_smp);
        ...
        histori.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PelajaranSmpActivity.this, HistoryMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranSmpActivity.this, SettingMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        transaksi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranSmpActivity.this, TransaksiMuridActivity.class);
                startActivity(i);
            }
        });
    ...
    private void fetchPelajaran() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, onPostsLoaded, new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder inetErr = new AlertDialog.Builder(PelajaranSmpActivity.this);
...
//            pel data = new Gson().fromJson(getIntent().getStringExtra("data"), pel.class);
            List<pel> test = Arrays.asList(gson.fromJson(response, pel[].class));
            adapter = new PelajaranSmpAdapter(test);

            adapter.setListener(new ItemClickListenerPelajaran() {
                @Override
                public void onClicked(pel pel, int position, View view) {
                    Intent i = new Intent(PelajaranSmpActivity.this, ListGuruSmpActivity.class);
