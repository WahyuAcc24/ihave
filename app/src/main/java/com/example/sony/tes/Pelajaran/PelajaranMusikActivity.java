...
import com.example.sony.tes.Adapter.PelajaranMusikAdapter;
 ...
 */
public class PelajaranMusikActivity extends AppCompatActivity {
    ...
    Button btnlain;
    private PelajaranMusikAdapter adapter;




    //    private  static  final String url = "http://t-hisyam.net/demo/whyri/vote/list_vote.php";
    private static final String url = "http://demo.t-hisyam.net/ihave/api/lesson/get_data?id_category=9";
...
//        getSupportActionBar().hide();
        ...
        lstPelajaran = (RecyclerView) findViewById(R.id.lst_pel_musik);
        ...
        btnlain = (Button) findViewById(R.id.btnLainnya);
        btnlain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranMusikActivity.this, LainnyaActivity.class);
                startActivity(i);
            }
        });
        ...
        histori.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranMusikActivity.this, HistoryMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranMusikActivity.this, SettingMuridActivity.class);
                startActivity(i);
            }
        });
        ...
        transaksi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PelajaranMusikActivity.this, TransaksiMuridActivity.class);
                startActivity(i);
            }
        });
    ...
    private void fetchPelajaran() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, onPostsLoaded, new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder inetErr = new AlertDialog.Builder(PelajaranMusikActivity.this);
...
//            pel data = new Gson().fromJson(getIntent().getStringExtra("data"), pel.class);
            ...
            adapter = new PelajaranMusikAdapter(test);

            adapter.setListener(new ItemClickListenerPelajaran() {
                @Override
                public void onClicked(pel pel, int position, View view) {
                    Intent i = new Intent(PelajaranMusikActivity.this, ListGuruSdActivity.class);
