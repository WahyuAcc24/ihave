 ...
 */
public class RegisterMuridActivity extends AppCompatActivity {
    ...
    private String url = server.URL + "murid/create";
    private static final String TAG = RegisterMuridActivity.class.getSimpleName();
    ...
    public void tampilGaleri() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RegisterMuridActivity.this);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CAMERA) {
                ...
                try {
                    ...
                    bitmap = MediaStore.Images.Media.getBitmap(RegisterMuridActivity.this.getContentResolver(), data.getData());
                    setToImageView(getResizedBitmap(bitmap, max_resolution_image));
                } catch (IOException e) {
                    e.printStackTrace();
                }
