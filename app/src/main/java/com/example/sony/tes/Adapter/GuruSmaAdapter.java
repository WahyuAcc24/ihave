 ...
 */
public class GuruSmaAdapter extends RecyclerView.Adapter<GuruSmaAdapter.Holder> {
    ...
    public GuruSmaAdapter(Guru[] guru, Context context) {
        this.guru =  guru;
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_guru_sma, parent, false));
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View itemView) {
            super(itemView);
            btnGuru = (Button) itemView.findViewById(R.id.grid_item_guru_sma);
