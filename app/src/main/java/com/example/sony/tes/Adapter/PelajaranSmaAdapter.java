 ...
 */
public class PelajaranSmaAdapter extends RecyclerView.Adapter<PelajaranSmaAdapter.Holder> {


    private List<pel> pels;
    private ItemClickListenerPelajaran listener;

    public PelajaranSmaAdapter(List<pel> pels) {
        this.pels = pels;
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_course_sma, parent, false));
    }
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View itemView) {
            super(itemView);
            btnPel = (Button) itemView.findViewById(R.id.item_course_sma);
